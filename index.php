				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="/hotel/admin/index.php" class="menu__link scroll">Login</a></li>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About YOUR HOTEL</h3> 
						   <p class="about-para-w3ls">a reward program that gives frequent hotel guests benefits like room upgrades, early check-in, and lounge access.</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+977 9865768834</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="yourhotel581@gmail.com">yourhotel@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Sudurpashchim Silgadhi-06 Doti Nepal</p>
